...
const SocialIcon: React.FC<{ children: React.ReactNode, href: string, label: string }> = ({ children, href, label }) => (
    <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="outline-draw dark:text-white/40 text-black/40 dark:hover:text-white hover:text-black transition-all p-3 dark:bg-white/[0.03] bg-black/[0.03] border dark:border-white/[0.05] border-black/[0.05] group flex items-center justify-center min-w-[48px] min-h-[48px] rounded-lg"
    >
    ...
    return (
        ...
        >
            ...
            <motion.div variants={item}>
                <SocialIcon href="https://x.com/teshxhabtiex" label="X (Twitter)">
            ...
            {/* GitHub */}
            <motion.div variants={item}>
                <SocialIcon href="https://github.com/teshx" label="GitHub">
            ...
            {/* LinkedIn */}
            <motion.div variants={item}>
                <SocialIcon href="https://linkedin.com/in/teshx" label="LinkedIn">
            ...
            {/* Telegram */}
            <motion.div variants={item}>
                <SocialIcon href="https://t.me/teshx1" label="Telegram">
            ...
            {/* Email */}
            <motion.div variants={item}>
                <SocialIcon href="mailto:teshie00001@gmail.com" label="Email">
